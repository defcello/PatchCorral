...
PATCHES = {
  ...
  'Celeste': [
    MIDIVoice('FS Celeste', 87, 64, 49, 'KEYBOARDS', 'PR-A 050'),  #Great!
    MIDIVoice('Celeste', 121, 0, 8, 'KEYBOARDS', 'GM 025'),
    MIDIVoice('Celeste SRX', 93, 9, 39, 'KEYBOARDS', 'XP-E 296'),
  ],
  'Chapel Organ': [
  ...
  'Keyboard 2': Part(
    ...
    [
      ...
      (
        ...
        (('Oboe', 'Bassoon'), ('Flute (8vb) + Glock', 'Bassoon'), ('Section Strings', 'Bassoon'), 'Section Strings', 'Harp', 'High Strings', ('Celeste', 'Section Strings'), ('Section Strings', 'Bassoon'), 'Marcato Horns', 'Fast Strings', 'Bright Rock Piano', ),
      )
      #Song 2A
      (
        'After Big Bright Beautiful World',
        ('Dirty Rock Piano', 'Marcato Horns', ),
      )
      #Song 3
      (
        'Story of My Life',
        (('Celeste', 'Bassoon'), ('Marcato Horns', 'Bassoon'), ('Marcato Horns', 'Wurly'), ('Marcato Horns', 'Marcato Trombones'), 'Grand Piano', 'Pizzicato Strings', ('Celeste', 'Harp'), 'Oboe', 'Marcato Horns', ('Section Strings', 'Bari Sax'), ('Marcato Horns', 'Bari. Sax'), ('Strings', 'Bari. Sax'), ),
      )
      #Song 3A
      (
        'Story of My Life - Tag',
        ('Celeste', 'Muted Strings', ),
      )
      #Song 3B
      (
        'The Goodbye Song',
        (('Pizzicato Strings', 'Bass Clarinet'), 'Tenor Sax', ),
      )
      #Song 3C
      (
        'Shrek Crossover',
      ...
      (
        'Don\'t Let Me Go',
        ('Pizzicato Strings', 'Piano', 'Rhodes', 'Strings', ('Tremolo Strings', 'Rhodes'), ),
      )
      #Song 4A
      (
        'Regiment #1',
      ...
      (
        'Holiday for Duloc',
        (('Celeste', 'Cello + Bassoon'), 'Harp')
      )
      #Song 5
      (
        'What\'s Up, Duloc?',
        (('Oboes', 'Bassoon'), 'Piccolo', ('Harp', 'Trombones'), ('Trombones', 'Bari. Sax'), 'Cup Mute Trumpets', 'Flutes', 'Violas', 'Flute', 'Oboe', 'Clarinet', ('Harp Gliss', 'Timpani'), 'Pizzicato Strings', 'Section Strings', ('Marcato Horns', 'Bari. Sax'), ('Flutes', 'Marcato Horns'), ('Glockenspiel', 'Celeste'), ('Marcato Horns', 'Bass Clarinet'), ('Jazz Trombones', 'Bari. Sax'), ('Jazz Trumpets', 'Bari. Sax'), ('Jazz Trumpets', 'Jazz Trombones'), 'Rich Section Strings', 'Strings', 'Tremolo Strings', ('Pizzicato Strings', 'Marcato Horns'), ('Pizzicato Strings', 'Bari. Sax'), 'Marcato Violins + Xylophone 8va', ('Symphonic Trumpets', 'Bass Trombone'), )
      )
      #Song 5A
      (
        'The Raffle',
      ...
      (
        ...
        (('Marcato Horns', 'Marcato Trombones'), 'Marcato Trumpet', 'Trombone', 'Flute', ('Marcato Trumpets', 'Marcato Horns'), ('Trumpets', 'Horns', 'Trombone'), )
      )
      #Song 1
      (
        'Overture',
